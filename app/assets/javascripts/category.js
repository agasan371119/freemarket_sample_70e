$(function () {
  ...
  function appendChidrenBox(insertHTML){
    ...
    childSelectHtml = `<div class="item__post__container__third__categoryform" id="children_wrapper">
                        <div class="input__category1">
                          <select class="input__category" name="item[category]" id="child_category"><option value="選択してください">選択してください</option>
                            ${insertHTML}
                          </select>
                        </div>
                       </div>`;
  ...
  function appendGrandchidrenBox(insertHTML){
    ...
    grandchildSelectHtml = `<div class="item__post__container__third__categoryform" id="grandchildren_wrapper">
                             <div class="input__category1">
                               <select class="input__category" name="item[category]" id="grandchild_category"><option value="選択してください">選択してください</option>
                                 ${insertHTML}
                               </select>
                             </div>
                           </div>`;
